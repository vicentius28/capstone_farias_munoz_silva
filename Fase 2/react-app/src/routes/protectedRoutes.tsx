...
const LicenciaPage = lazy(() => import("@/shared/pages/Licencia/Licencia"));
const LicenciaCalendarioPage = lazy(
  () => import("@/shared/pages/Licencia/Calendario"),
);
const ProtocolosPage = lazy(() => import("@/shared/pages/Protocolo/Protocolo"));
...
export const protectedRoutes: RouteObject[] = [
  {
    ...
    children: [
      ...
      
      {
        path: "licencia-crear",
        element: (
          <ProtectedRoute permiso={PERMISSIONS.LICENCIAS.CREAR}>
            {withSuspense(LicenciaPage)}
          </ProtectedRoute>
        ),
      },
      {
        path: "licencia-calendario",
        element: (
          <ProtectedRoute permiso={PERMISSIONS.DIRECTIVO.CALENDARIO_LICENCIAS}>
            {withSuspense(LicenciaCalendarioPage)}
          </ProtectedRoute>
        ),
      },
      {
        path: "licencia-calendario",
        element: (
          <ProtectedRoute permiso={PERMISSIONS.LICENCIAS.CALENDARIO}>
            {withSuspense(LicenciaCalendarioPage)}
          </ProtectedRoute>
        ),
      },
      {
        path: "protocolos",
        element: (
          <ProtectedRoute permiso={PERMISSIONS.PORTAL.PROTOCOLOS}>
            {withSuspense(ProtocolosPage)}
          </ProtectedRoute>
        ),
      },
      {
