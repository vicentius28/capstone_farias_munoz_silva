...
from proyectoapp.models.estructura import Cargo, Ciclo, Codigo, Genero
from proyectoapp.models.formacion import Titulo, Magister, Diplomado
...
class User(AbstractUser, ContractMixin, AssignmentMixin):
    ...
    titulos = models.ManyToManyField(
        Titulo, 
        through='UsuarioTitulo', 
        blank=True,
        verbose_name="Títulos"
    )
    magisters = models.ManyToManyField(
        Magister, 
        through='UsuarioMagister', 
        blank=True,
        verbose_name="Magísteres"
    )
    diplomados = models.ManyToManyField(
        Diplomado, 
        through='UsuarioDiplomado', 
        blank=True,
        verbose_name="Diplomados"
    )
