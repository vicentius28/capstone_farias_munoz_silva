...
const EvaluacionCard = memo(function EvaluacionCard({
  item,
  finalizada,
  onOpen,
}: Props) {
  ...
  const handleClick = useCallback(
    () => onOpen(item.id, finalizada),
    [item.id, finalizada, onOpen],
  );
      ...
      <div className="space-y-3">
        <div className="flex items-center text-sm text-gray-600">
          <div className="mr-3 flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-r from-blue-100 to-purple-100">
            ...
            >
              <path
                d="M8 7V3a1 1 0 011-1h6a1 1 0 011 1v4M8 7h8M8 7a1 1 0 00-1 1v8a1 1 0 001 1h8a1 1 0 001-1V8a1 1 0 00-1-1"
                strokeLinecap="round"
        ...
        {!finalizada && (
          <div className="flex items-center">
            <div
              className={`mr-3 flex h-8 w-8 items-center justify-center rounded-xl ${
                faltantes > 0
            ...
            <span
              className={`text-sm font-medium ${faltantes > 0 ? "text-orange-700" : "text-green-700"}`}
            >
              {faltantes > 0
      ...
      <div className="mt-4 border-t border-gray-100 pt-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center text-xs font-medium text-blue-600 transition-colors group-hover:text-blue-700">
            <span className="mr-1">
              {finalizada ? "Ver detalles" : "Continuar"}
            </span>
            <svg
              aria-hidden="true"
