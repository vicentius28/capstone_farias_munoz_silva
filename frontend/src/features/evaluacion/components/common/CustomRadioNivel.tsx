...
const VARIANTS = {
  emerald: {
    container:
      "data-[selected=true]:border-emerald-500 data-[selected=true]:bg-emerald-50/50",
    badge: "bg-emerald-100 text-emerald-700",
    icon: "text-emerald-500",
  },
  amber: {
    container:
      "data-[selected=true]:border-amber-500 data-[selected=true]:bg-amber-50/50",
...
export const CustomRadioNivel = ({
  ...
  const { Component, isSelected, getBaseProps, getInputProps, getLabelProps } =
    useRadio(props);
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          color:
            isSelected && colorScheme === "emerald"
              ? "rgba(16, 185, 129, 0.1)"
              : "transparent", // Truco visual sutil
        }}
      />
    </Component>
  );
