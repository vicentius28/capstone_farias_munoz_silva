          ...
          return (
            <div
              ...
              className={`transition-all duration-200 ${
                isCompleted
                  ? "bg-green-50/40 border-l-4 border-l-green-400"
            ...
            >
                          ...
                          <Tooltip
                            ...
                            content={
                              <div className="max-w-md p-4">
                                ...
                                <div className="text-md text-default-700 leading-relaxed">
                                  {indicador.definicion}
                                </div>
                              </div>
                            }
              ...
              <div className="lg:hidden p-2 space-y-2 bg-white dark:bg-default-50">
                ...
                <div className="space-y-4">
                  <h5 className="text-sm font-medium text-default-700 text-center">
                    Selecciona el nivel de logro:
                  </h5>
                  <RadioGroup
