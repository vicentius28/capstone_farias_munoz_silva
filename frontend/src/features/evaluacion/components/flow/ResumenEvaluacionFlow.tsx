      ...
      <CardHeader className="flex justify-between items-start">
        <div>
          <h3 className="text-lg font-semibold">
            Evaluación de {evaluacion.persona?.first_name}{" "}
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-sm">
                {evaluacion.estado_actual || "Pendiente"}
              </p>
            </div>
            ...
            {evaluacion.fecha_reunion && (
              <div>
                ...
                <p className="text-sm">
                  {formatDate(evaluacion.fecha_reunion)}
                </p>
              </div>
            )}
          </div>
          ...
          {(evaluacion.firmado_obs || evaluacion.estado_firma === "firmado") &&
            evaluacion.motivo_denegacion && (
              <div>
                <h4 className="font-medium text-sm text-danger-700 mb-2">
                  Motivo de Denegación
                </h4>
                <div className="bg-danger-50 p-3 rounded-lg border border-danger-200">
                  <p className="text-sm whitespace-pre-wrap text-danger-800">
                    {evaluacion.motivo_denegacion}
                  </p>
                </div>
              </div>
          ...
          {evaluacion.fecha_firma && evaluacion.firmado && (
            <div>
              <h4 className="font-medium text-sm text-success-700 mb-2">
                Fecha de Aceptación
              </h4>
          ...
          {(evaluacion.text_destacar || evaluacion.text_mejorar) && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {evaluacion.text_mejorar && (
                <div>
                  <h4 className="font-medium text-sm text-warning-700 mb-2">
                    A Mejorar
                  </h4>
