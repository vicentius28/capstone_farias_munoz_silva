        ...
        <Card className="mb-12 bg-white/80 backdrop-blur-xl border-0 shadow-2xl dark:bg-slate-900/80">
          <CardBody className="p-12 text-center">
            ...
            <p className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Sistema integral de evaluación que potencia tu crecimiento
              profesional. Mide logros, identifica oportunidades de mejora y
              planifica tu desarrollo futuro con herramientas de vanguardia.
            </p>
        ...
        <div className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600 dark:text-slate-300 text-lg max-w-2xl mx-auto">
              Un proceso estructurado en 2 etapas diseñado para maximizar tu
              ...
              >
                <CardHeader className="pb-4">
                  <div className="flex items-center gap-4 w-full">
                    <div
                      className={`flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-r ${paso.iconBg} shadow-lg group-hover:rotate-6 transition-transform duration-300`}
                    >
                      <div className="text-white">{paso.icon}</div>
                    </div>
                    <Chip
                      className="font-bold"
              ...
              {criterios.map((criterio, index) => (
                ...
                >
                  <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-gradient-to-r from-blue-500 to-indigo-600 shadow-md flex-shrink-0">
                    <div className="text-white">{criterio.icon}</div>
                  </div>
