  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center min-h-screen">
        <Spinner label="Cargando evaluaciones..." size="lg" />
      </div>
    );
  }
  ...
  const criterios = [
    {
      ...
      description: "Evaluación de habilidades específicas del puesto",
      icon: "🎯",
    },
    {
      title: "Competencias Conductuales",
      description: "Análisis de comportamientos y actitudes",
      icon: "🤝",
    },
    {
      title: "Resultados y Logros",
      description: "Medición de objetivos alcanzados",
      icon: "📊",
    },
    {
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto leading-relaxed">
            Compara y analiza las evaluaciones desde múltiples perspectivas para
          ...
          <Card className="bg-white/70 backdrop-blur-sm border-0 shadow-xl">
            <CardBody className="text-center py-12">
              ...
              <p className="text-slate-600 max-w-md mx-auto">
                Intenta ajustar los filtros para encontrar las evaluaciones que
                buscas.
              </p>
              <Button
                className="mt-4"
