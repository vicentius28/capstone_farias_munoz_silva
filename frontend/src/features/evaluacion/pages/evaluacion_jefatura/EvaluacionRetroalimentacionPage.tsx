...
export default function EvaluacionRetroalimentacionPage() {
  ...
  const handleCompletarRetroalimentacion = async () => {
    ...
    try {
      ...
      const response = await completarRetroalimentacionYCerrar(
        evaluacion.id,
        retroalimentacion,
      );
  ...
  const puedeCompletarRetroalimentacion =
    evaluacion?.completado && !evaluacion?.retroalimentacion_completada;
          ...
          <Textarea
            description={
              evaluacion?.retroalimentacion_completada
                ? "La retroalimentación ya ha sido completada"
                : "Proporcione comentarios constructivos sobre el desempeño"
            }
